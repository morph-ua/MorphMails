...
type Client struct {
	...
	Letter *LetterClient
	// Receiver is the client for interacting with the Receiver builders.
...
func (c *Client) init() {
	...
	c.Receiver = NewReceiverClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		Receiver:  NewReceiverClient(cfg),
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Letter.Intercept(interceptors...)
	c.Receiver.Intercept(interceptors...)
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *LetterMutation:
		return c.Letter.mutate(ctx, m)
	case *ReceiverMutation:
		return c.Receiver.mutate(ctx, m)
	case *UserMutation:
...
// QueryReceivers queries the receivers edge of a Connector.
func (c *ConnectorClient) QueryReceivers(co *Connector) *ReceiverQuery {
	query := (&ReceiverClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := co.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(connector.Table, connector.FieldID, id),
			sqlgraph.To(receiver.Table, receiver.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, connector.ReceiversTable, connector.ReceiversColumn),
		)
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `letter.Intercept(f(g(h())))`.
func (c *LetterClient) Intercept(interceptors ...Interceptor) {
	c.inters.Letter = append(c.inters.Letter, interceptors...)
}

// Create returns a builder for creating a Letter entity.
...
// UpdateOneID returns an update builder for the given id.
func (c *LetterClient) UpdateOneID(id string) *LetterUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LetterClient) DeleteOneID(id string) *LetterDeleteOne {
...
func (c *LetterClient) Query() *LetterQuery {
	return &LetterQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLetter},
		inters: c.Interceptors(),
	}
}

// Get returns a Letter entity by its id.
func (c *LetterClient) Get(ctx context.Context, id string) (*Letter, error) {
	return c.Query().Where(letter.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LetterClient) GetX(ctx context.Context, id string) *Letter {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Interceptors returns the client interceptors.
func (c *LetterClient) Interceptors() []Interceptor {
	return c.inters.Letter
}

func (c *LetterClient) mutate(ctx context.Context, m *LetterMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LetterCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LetterUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LetterUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LetterDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown Letter mutation op: %q", m.Op())
	}
}

// ReceiverClient is a client for the Receiver schema.
type ReceiverClient struct {
	config
}

// NewReceiverClient returns a client for the Receiver from the given config.
func NewReceiverClient(c config) *ReceiverClient {
	return &ReceiverClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `receiver.Hooks(f(g(h())))`.
func (c *ReceiverClient) Use(hooks ...Hook) {
	c.hooks.Receiver = append(c.hooks.Receiver, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `receiver.Intercept(f(g(h())))`.
func (c *ReceiverClient) Intercept(interceptors ...Interceptor) {
	c.inters.Receiver = append(c.inters.Receiver, interceptors...)
}

// Create returns a builder for creating a Receiver entity.
func (c *ReceiverClient) Create() *ReceiverCreate {
	mutation := newReceiverMutation(c.config, OpCreate)
	return &ReceiverCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of Receiver entities.
func (c *ReceiverClient) CreateBulk(builders ...*ReceiverCreate) *ReceiverCreateBulk {
	return &ReceiverCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for Receiver.
func (c *ReceiverClient) Update() *ReceiverUpdate {
	mutation := newReceiverMutation(c.config, OpUpdate)
	return &ReceiverUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ReceiverClient) UpdateOne(r *Receiver) *ReceiverUpdateOne {
	mutation := newReceiverMutation(c.config, OpUpdateOne, withReceiver(r))
	return &ReceiverUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ReceiverClient) UpdateOneID(id string) *ReceiverUpdateOne {
	mutation := newReceiverMutation(c.config, OpUpdateOne, withReceiverID(id))
	return &ReceiverUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for Receiver.
func (c *ReceiverClient) Delete() *ReceiverDelete {
	mutation := newReceiverMutation(c.config, OpDelete)
	return &ReceiverDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ReceiverClient) DeleteOne(r *Receiver) *ReceiverDeleteOne {
	return c.DeleteOneID(r.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ReceiverClient) DeleteOneID(id string) *ReceiverDeleteOne {
	builder := c.Delete().Where(receiver.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ReceiverDeleteOne{builder}
}

// Query returns a query builder for Receiver.
func (c *ReceiverClient) Query() *ReceiverQuery {
	return &ReceiverQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeReceiver},
		inters: c.Interceptors(),
	}
}

// Get returns a Receiver entity by its id.
func (c *ReceiverClient) Get(ctx context.Context, id string) (*Receiver, error) {
	return c.Query().Where(receiver.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ReceiverClient) GetX(ctx context.Context, id string) *Receiver {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryUser queries the user edge of a Receiver.
func (c *ReceiverClient) QueryUser(r *Receiver) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(receiver.Table, receiver.FieldID, id),
...
// QueryConnector queries the connector edge of a Receiver.
func (c *ReceiverClient) QueryConnector(r *Receiver) *ConnectorQuery {
...
// Hooks returns the client hooks.
func (c *ReceiverClient) Hooks() []Hook {
	return c.hooks.Receiver
}

// Interceptors returns the client interceptors.
func (c *ReceiverClient) Interceptors() []Interceptor {
	return c.inters.Receiver
}

func (c *ReceiverClient) mutate(ctx context.Context, m *ReceiverMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ReceiverCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ReceiverUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ReceiverUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ReceiverDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown Receiver mutation op: %q", m.Op())
	}
}
...
// QueryReceivers queries the receivers edge of a User.
func (c *UserClient) QueryReceivers(u *User) *ReceiverQuery {
	query := (&ReceiverClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(receiver.Table, receiver.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.ReceiversTable, user.ReceiversColumn),
		)
...
type (
	hooks struct {
		Connector, Letter, Receiver, User []ent.Hook
	}
	inters struct {
		Connector, Letter, Receiver, User []ent.Interceptor
	}
)
